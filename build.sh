...
# linux
go build -o wazuh/linux/master_ar_linux go_src/master_ar_linux.go
go build -o wazuh/linux/ar_file_list_linux go_src/ar_file_list_linux.go
go build -o wazuh/linux/ar_file_delete_linux go_src/ar_file_delete_linux.go
